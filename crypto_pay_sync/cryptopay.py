...
class Crypto:
    ...
    def get_invoices(self, asset=None, invoice_ids=None, status=None, offset=0, count=100):
        """Use this method to get invoices of your app.

        Args:
            asset (str, optional): Cryptocurrency alphabetic code. Supported assets: “USDT”, “TON”, “BTC”, “ETH”, “LTC”, “BNB”, “TRX” and “USDC”. Defaults to all currencies.
            invoice_ids (Union[str, List[int]], optional): Invoice IDs separated by comma (list in Python).
            status (str, optional): Status of invoices to be returned. Available statuses: “active” and “paid”. Defaults to all statuses.
            offset (int, optional): Offset needed to return a specific subset of invoices. Default is 0.
            count (int, optional): Number of invoices to be returned. Values between 1-1000 are accepted. Default is 100.

        Returns:
            dict: Array of invoices
        """
        url = f'{self.url}/getInvoices'
